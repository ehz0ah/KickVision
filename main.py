...
def main():
    ...
    camera_movement_estimator.add_adjust_positions_to_trackers(tracks, camera_movement_per_frame)
    ...
    # Add speed and distance to the tracks
